...
const source = new eventsource_1.default(process.env.STREAMDATA || "https://www.blaseball.com/events/streamData", { withCredentials: true, headers: { "User-Agent": "node-blaseball" } });
